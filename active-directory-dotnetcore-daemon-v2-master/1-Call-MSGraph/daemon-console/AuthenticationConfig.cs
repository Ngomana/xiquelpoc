...
namespace daemon_console
{
    ...
    public class AuthenticationConfig
    {
        ...
        public string getUsers { get; set; } = "https://graph.microsoft.com/v1.0/users";
        public string getGroups { get; set; } = "https://graph.microsoft.com/v1.0/groups";
        public string getGroupMembers { get; set; } = "https://graph.microsoft.com/v1.0/groups/";
